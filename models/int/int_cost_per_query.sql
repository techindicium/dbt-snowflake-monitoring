...
, query_hours as (
    select
        ...
        , filtered_queries.original_query_text
        , filtered_queries.credits_used_cloud_services
        , filtered_queries.warehouse_id
        , filtered_queries.ran_on_warehouse
        , filtered_queries.execution_start_time
        , filtered_queries.start_time
        , filtered_queries.end_time
        , filtered_queries.query_acceleration_bytes_scanned
    from hours_list
    inner join filtered_queries
        on hours_list.hour_start >= date_trunc('hour', filtered_queries.execution_start_time)
            and hours_list.hour_start < filtered_queries.end_time
            and filtered_queries.ran_on_warehouse
)
